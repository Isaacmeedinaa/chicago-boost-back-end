...
const userSchema = new mongoose.Schema(
  {
    ...
    pushToken: { type: String, min: 1, unique: true, required: false },
  },
  { timestamps: true }
);
...
const userValidator = (user) => {
  const schema = Joi.object({
    ...
    phoneNumber: Joi.string().min(10).max(10).required().messages({
      ...
      "string.min": "Phone number should at least be 10 characters long.",
      "string.max": "Phone number should not be over 10 characters long.",
    }),
